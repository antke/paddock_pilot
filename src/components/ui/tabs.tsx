...
function TabsTrigger({ className, ...props }: TabsPrimitive.Tab.Props) {
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        "relative inline-flex h-full flex-1 cursor-pointer items-center justify-center gap-1.5 rounded-control border border-transparent px-3 py-1.5 text-sm font-semibold whitespace-nowrap text-foreground/65 transition-[background-color,border-color,color,box-shadow] duration-150 group-data-vertical/tabs:w-full group-data-vertical/tabs:justify-start group-data-vertical/tabs:py-[calc(--spacing(1.5))] hover:text-foreground focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/25 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 has-data-[icon=inline-end]:pr-2 has-data-[icon=inline-start]:pl-2 aria-disabled:pointer-events-none aria-disabled:opacity-50 dark:text-muted-foreground dark:hover:text-foreground [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        'group-data-[variant=line]/tabs-list:bg-transparent group-data-[variant=line]/tabs-list:data-active:bg-transparent dark:group-data-[variant=line]/tabs-list:data-active:border-transparent dark:group-data-[variant=line]/tabs-list:data-active:bg-transparent',
        'group-data-[variant=section]/tabs-list:h-10 group-data-[variant=section]/tabs-list:flex-none group-data-[variant=section]/tabs-list:px-3.5 group-data-[variant=section]/tabs-list:py-2 group-data-[variant=section]/tabs-list:font-display group-data-[variant=section]/tabs-list:text-sm group-data-[variant=section]/tabs-list:font-bold group-data-[variant=section]/tabs-list:uppercase group-data-[variant=section]/tabs-list:leading-none group-data-[variant=section]/tabs-list:tracking-[0.025em]',
