...
const dropdownMenuItemClassName =
  "relative flex cursor-pointer items-center gap-2 rounded-control px-2 py-2 text-xs font-medium outline-hidden select-none focus:bg-primary/8 focus:text-foreground data-inset:pl-7 data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
    ...
    <MenuPrimitive.Portal data-slot="dropdown-menu-portal">
      ...
      >
        <MenuPrimitive.Popup
          ...
          className={cn(
            'z-50 max-h-(--available-height) w-(--anchor-width) min-w-32 origin-(--transform-origin) overflow-x-hidden overflow-y-auto rounded-row border border-border bg-popover p-1 text-popover-foreground shadow-control duration-100 outline-none data-[side=bottom]:slide-in-from-top-2 data-[side=inline-end]:slide-in-from-left-2 data-[side=inline-start]:slide-in-from-right-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:overflow-hidden data-closed:fade-out-0 data-closed:zoom-out-95',
            className,
          )}
          {...props}
        />
...
function DropdownMenuSubTrigger({
  ...
  return (
    <MenuPrimitive.SubmenuTrigger
      ...
      className={cn(
        dropdownMenuItemClassName,
        'data-popup-open:bg-primary/10 data-popup-open:text-foreground data-open:bg-primary/10 data-open:text-foreground',
        className,
      )}
      {...props}
    >
